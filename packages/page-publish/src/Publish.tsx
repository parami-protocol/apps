  ...
  return (
    <section className={className}>
      <div className="ui--row">
        <div className="large">
          <h2>发布广告</h2>
          <Input maxLength={50} min={2} onChange={setName} label="Ads Name" placeholder="请输入广告名称" />
          <Input maxLength={50} min={2} onChange={setTopic} label="Ads Topic" placeholder="请输入广告所属行业" />
          <InputBalance
          ...
          <InputBalance
            ...
            value={singleClick}
          />
          <Input maxLength={350} min={2} onChange={setDisplayPage} label="Ads Image" placeholder="请输入广告展示图" />
          <Input min={1} onChange={setLandingPage} label="Ads Link" placeholder="请输入广告跳转链接" />
          <Dropdown label="广告类型" onChange={setAdsType} options={DISTRIBUTE_ENUM} value={adsType} />
          <Button.Group>
            <TxButton
              accountId={accountId}
